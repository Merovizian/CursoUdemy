    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            bancoDados.execSQL("CREATE TABLE IF NOT EXISTS" +
                    " pessoas (id INTEGER PRIMARY KEY AUTOINCREMENT, nome VARCHAR, idade INT(3))");
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ATUALIZANDO E REMOVENDO REGISTROS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        //bancoDados.execSQL("UPDATE pessoas SET idade = 19 WHERE nome LIKE 'Eric%'");
        //bancoDados.execSQL("UPDATE pessoas SET idade = 18, nome = 'JESUS' WHERE nome LIKE 'Eric%'")
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ PRINTANDO OS RESULTADOS  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            Cursor cursor = bancoDados.rawQuery("SELECT * " +
                    " FROM pessoas",null);
            ...
            int indiceCod = cursor.getColumnIndex("id");
            ...
            while (cursor != null){
                ...
                String id = cursor.getString(indiceCod);
